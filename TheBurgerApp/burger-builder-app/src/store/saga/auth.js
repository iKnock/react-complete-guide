...
export function* checkAuthTimeoutSaga(action) {
    yield delay(action.expirationTime * 1000)  // wait for the token expiration
...
export function* authUserSaga(action) {
    ...
    if (!action.isSignup) {
        url = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB7AO2c-FEuooubfuH-XrXrvOOKeddl5PM'
    }
